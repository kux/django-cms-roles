...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cmsroles_role', (
            ...
            ('can_set_navigation', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ...
        db.send_create_signal('cmsroles', ['Role'])

        # Adding M2M table for field derived_global_permissions on 'Role'
        db.create_table('cmsroles_role_derived_global_permissions', (
        ...
        db.create_unique('cmsroles_role_derived_global_permissions', ['role_id', 'globalpagepermission_id'])


    def backwards(self, orm):
        # Deleting model 'Role'
        db.delete_table('cmsroles_role')

        # Removing M2M table for field derived_global_permissions on 'Role'
        db.delete_table('cmsroles_role_derived_global_permissions')
